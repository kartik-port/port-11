		...
		<section className="w-full min-h-screen">
								...
								<div className="w-[50%] flex flex-col gap-y-[40px] sm:w-full xm:w-full">
									<div className="flex flex-col gap-y-[20px]">
										<p className="paragraph font-NeueMontreal text-secondry">
											I&apos;m Kartik Mhatre, also known as Otisium.
											<br /> I&apos;m an AI/ML student and full-stack developer
											<br />
											passionate about building intelligent
											<br /> applications that solve real-world <br />
											problems.
										</p>
									</div>
									<div className="flex flex-col gap-y-[20px]">
										<p className="paragraph font-NeueMontreal text-secondry">
											...
											<br />
											and JavaScript for web development, and
											<br /> Python, TensorFlow, and NLP for AI/ML
											<br />
											projects. I love bridging the gap between
											<br />
											cutting-edge technology and practical
											<br />
											solutions.
										</p>
									</div>
			...
			<div className="padding-x">
				<h1 className="sub-heading font-medium font-NeueMontreal text-secondry">
					I build intelligent applications that make
					<br className="sm:hidden xm:hidden" /> technology accessible and useful for everyone.
				</h1>
			</div>
		</section>
	);
