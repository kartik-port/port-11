		...
		<section className="w-full bg-about padding-y rounded-t-[20px] z-20 relative mt-[-15px]">
			<div className="pl-[50px] sm:px-[20px] xm:px-[20px]">
				<h2 className="sub-heading font-medium font-NeueMontreal text-secondry">
					I'm a passionate AI/ML student and full-stack developer
					<br className="sm:hidden xm:hidden" /> with expertise in React, Next.js, Node.js, and JavaScript. I love&nbsp;
					<span className="sub-heading font-medium font-NeueMontreal link-flash cursor-pointer">
						building intelligent applications
					</span>
					&nbsp;that solve real-world problems <br className="sm:hidden xm:hidden" />
					<span className="sub-heading font-medium font-NeueMontreal link-flash cursor-pointer">
						and bridge the gap
					</span>
					&nbsp;between&nbsp;
						...
						<div className="w-full flex gap-[30px] h-full items-end sm:items-start sm:flex-col xm:items-start xm:flex-col">
							<div className="w-[40%] sm:w-[60%] xm:w-[60%]">
								<p className="sub-paragraph font-medium font-NeueMontreal text-secondry tracking-wide">
									Proficient in modern frontend technologies including React, Next.js, HTML, CSS, and JavaScript. 
									I create responsive, user-friendly interfaces with a focus on performance and accessibility.
								</p>
								<p className="sub-paragraph font-medium font-NeueMontreal text-secondry pt-[30px] tracking-wide">
									Experienced with Node.js for backend development and Python for AI/ML projects. I work with 
									TensorFlow, Scikit-learn, and Natural Language Processing to build intelligent systems.
								</p>
							</div>
