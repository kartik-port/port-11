...
export const footerItems = [
   {
      id: 1,
      title: "GitHub",
      href: "https://github.com/Kartikmhatre",
   },
   {
      id: 2,
      title: "LinkedIn",
      href: "https://www.linkedin.com/in/kartik-mhatre-4768b238a/",
   },
   {
      id: 3,
      title: "Twitter",
      href: "https://twitter.com/Kartikmhatre18",
   },
   {
      id: 4,
      title: "Email",
      href: "mailto:kartikmhatre1812@gmail.com",
   },
];
...
export const clientsItem = [
   {
      ...
      name: "Sarah Johnson",
      src: client01,
      review: "Working with this developer was an absolute pleasure. They delivered a high-quality web application that exceeded our expectations. The attention to detail, clean code, and responsive design made our product stand out. Communication was excellent throughout the project, and they were always available to address our concerns. Highly recommended! 5/5",
      links: [
         {
            id: 1,
            title: "React",
   ...
   {
      id: 2,
      website: "EcoSolutions",
      href: "https://www.ecosolutions.com",
      title: "Technologies:",
      name: "Michael Chen",
      src: client02,
      review: "This developer brought exceptional technical skills and creativity to our project. They understood our vision and transformed it into a beautiful, functional web application. The development process was smooth and efficient, with regular updates and clear communication. Their expertise in modern frameworks and attention to user experience made all the difference. We're thrilled with the results!",
      links: [
         {
            id: 1,
            title: "TypeScript",
   ...
   },
   {
      id: 3,
      website: "DigitalFlow",
      href: "https://www.digitalflow.com",
      title: "Technologies:",
      name: "Emma Rodriguez",
      src: client03,
      review: "This developer brought a level of professionalism and technical expertise that was exactly what we needed. The web application they built for us is fast, secure, and user-friendly. Our team was impressed with the clean architecture and scalable codebase. The final product exceeded our expectations and has significantly improved our workflow.",
      links: [
         {
            id: 1,
            title: "React",
   ...
   {
      id: 4,
      website: "AI Solutions Inc",
      href: "https://www.aisolutions.com",
      title: "Technologies:",
      name: "David Park",
      src: client04,
      review: "Working with this developer was a game-changer for our AI project. They delivered a sophisticated machine learning solution that exceeded our expectations. The integration of AI capabilities into our web platform was seamless, and the performance is outstanding. Highly skilled in both frontend and AI/ML technologies!",
      links: [
         {
            id: 1,
   ...
   },
   {
      ...
      href: "https://www.cloudtech.com",
      title: "Technologies:",
      name: "Lisa Anderson",
      src: client05,
      review: "This developer's expertise in full-stack development and AI/ML is truly impressive. They built us a complex web application with intelligent features that our users love. The attention to detail, clean code architecture, and innovative problem-solving approach made this project a huge success. We're already planning our next collaboration!",
      links: [
         {
            id: 1,
...
export const projectItem = [
   ...
   },
   {
      ...
      href: "https://upilinkgenerator.vercel.app/",
      src: project2,
      links: [
         {
            id: 1,
   ...
   },
   {
      id: 3,
      title: "PatterNix",
      href: "https://patter-nix.vercel.app/",
      src: project3,
      links: [
         {
            id: 1,
   ...
   },
   {
      id: 4,
      title: "MediaCraft",
      href: "https://mediacraft.onrender.com/",
      src: project4,
      links: [
         {
            id: 1,
...
export const presentationProjectItem = [
   ...
   },
   {
      ...
      title: "FlexiPDF",
      src: project4,
      href: "https://flexipdf-m7e1.onrender.com/",
      links: [
         {
            id: 1,
            title: "PDF Tools",
   ...
   },
   {
      ...
      title: "PrepWise",
      src: project5,
      href: "https://inter-prep-wise.onrender.com/",
      links: [
         {
            id: 1,
   ...
   {
      id: 5,
      title: "ImageEditGenie",
      src: project8,
      href: "https://erasebg-3m4s.onrender.com/",
      links: [
         {
            id: 1,
   ...
   },
   {
      ...
      title: "Voice Chat AI",
      src: project2,
      href: "https://voicechatai.wmart.in/",
      links: [
         {
            id: 1,
            title: "agency",
...
export const insightsPublicationItems = [
   ...
   {
      id: 2,
      title: "From Idea to Deployment: My Dev Journey",
      src: insights2
   },
   {
      id: 3,
      title: "Top 7 AI/ML Projects for Beginners",
      src: insights3
   },
];
...
export const latestItemss = [
   {
      id: 1,
      href: "https://github.com/Kartikmhatre/Ai-Resume-Builder",
      src: latest1,
      links: [
         {
            id: 1,
      ...
      title: "Building an AI-Powered Resume Builder: <br/> Lessons Learned and Best Practices.",
      subTitle: "By Kartik Mhatre (Otisium)",
      date: "26 Sep 2024"
   },
   {
      id: 2,
      href: "https://github.com/Kartikmhatre/FlexiPDF-",
      src: latest2,
      links: [
         {
            id: 1,
      ...
      title: "Creating FlexiPDF: A Free Web-Based PDF Tool for Everyone.",
      subTitle: "By Kartik Mhatre (Otisium)",
      date: "12 Oct 2024"
   },
];
